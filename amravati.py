...
website = 'https://www.mahahsscboard.in/list_school_static.php?div_id=IS1AYGAKYAo%3D&inst_type=IzonLUMKYAo%3D'
...
df.to_excel('Amravati College List.xlsx', index=False)
