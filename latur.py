...
website = 'https://www.mahahsscboard.in/list_school_static.php?div_id=IS5gYGAKYAo%3D&inst_type=IzonLUMKYAo%3D'
...
df.to_excel('Latur College List.xlsx', index=False)
