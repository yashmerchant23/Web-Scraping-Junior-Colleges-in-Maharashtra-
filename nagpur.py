...
website = 'https://www.mahahsscboard.in/list_school_static.php?div_id=ISxAYGAKYAo%3D&inst_type=IzonLUMKYAo%3D'
...
df.to_excel('Nagpur College List.xlsx', index=False)
