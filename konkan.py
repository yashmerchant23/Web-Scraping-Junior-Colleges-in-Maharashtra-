...
website = 'https://www.mahahsscboard.in/list_school_static.php?div_id=IS4wYGAKYAo%3D&inst_type=IzonLUMKYAo%3D'
...
df.to_excel('Konkan College List.xlsx', index=False)
