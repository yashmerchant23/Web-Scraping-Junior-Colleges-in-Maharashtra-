...
website = 'https://www.mahahsscboard.in/list_school_static.php?div_id=IS1gYGAKYAo%3D&inst_type=IzonLUMKYAo%3D'
...
df.to_excel('Mumbai College List.xlsx', index=False)
